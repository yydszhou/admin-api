    -- ============================================================
    -- RBAC 权限系统初始化测试数据
    -- 注意：密码均使用 BCrypt 加密（由 BCryptPasswordEncoder(10) 生成）
    --   admin123  → $2a$10$uEaIsKF9phR4UzqbyiKr6u5nqd3oW4JFmjxZscoZ.sUktdbY5ZCny
    --   oper123   → $2a$10$ZK6JTdz3wZuPbbYjig5JluIDYafVYsSc9UVUSgyaHdD9zlyzkCh/e
    --   audit123  → $2a$10$afTzO0fpaQ975H2dQIwLD.JKAbZHeJHsyPXLG2IgNX6jN4gqAiL/m
    -- ============================================================
    ...
    VALUES
        (1, 'admin',    'admin@example.com',    '$2a$10$uEaIsKF9phR4UzqbyiKr6u5nqd3oW4JFmjxZscoZ.sUktdbY5ZCny', 1),
        (2, 'operator', 'operator@example.com', '$2a$10$ZK6JTdz3wZuPbbYjig5JluIDYafVYsSc9UVUSgyaHdD9zlyzkCh/e', 1),
        (3, 'auditor',  'auditor@example.com',  '$2a$10$afTzO0fpaQ975H2dQIwLD.JKAbZHeJHsyPXLG2IgNX6jN4gqAiL/m', 1);
